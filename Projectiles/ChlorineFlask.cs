...
{
    public class ChlorineFlask : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int d = 0; d < 15; d++)
            {
                ...
                Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0f, 0f, mod.ProjectileType("ChlorineCloud"), projectile.damage, 0f, projectile.owner);
            }
