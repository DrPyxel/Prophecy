...
{
    public class BoronGrenadeL : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0f, 0f, mod.ProjectileType("AlchemistExplode"), projectile.damage, 0f, projectile.owner);
        }
    }
}