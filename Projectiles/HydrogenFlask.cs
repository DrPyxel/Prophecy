...
{
    public class HydrogenFlask : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int d = 0; d < 15; d++)
            {
                Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.SilverCoin, 0f, 0f, 125, default(Color), 2f);
                Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.Tin, 0f, 0f, 125, default(Color), 2f);
                Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0f, 0f, mod.ProjectileType("HydrogenCloud"), projectile.damage, 0f, projectile.owner);
            }
